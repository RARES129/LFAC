...
%token <strval>ID STARTCLASS ENDCLASS STARTFCT ENDFCT BGIN END CLASS <intval>NR String LOOP <strval>TIP <strval>ARRAYTYPE STARTSTR ENDSTR RET <strval>ASSIGN PLUS OR AND MULTIPLY DIVIDE MODULO MINUS DECL FUNC CTRL LOOPF LOOPW OPR; 
